const { User, Oc, Detalleoc } = require('../db');
const mercadopago = require('mercadopago');
const nodemailer = require('nodemailer');
require('dotenv').config();

const { GOOGLE_TOKEN } = process.env;
const eURL = 'https://4102-191-82-44-7.ngrok.io';
...
//           const usuario = await User.findOne({ where: { email: data.payer.email } });
...
//         const usuario = await User.findOne({ where: { email: correoUsuario } });
